    ...
    public static class SettingsHelper
    {
        ...
        public static void InitDefaultItems(this Settings settings)
        {
            settings.MonitorItems = new List<MonitorItemConfig>
            {
                ...
                // [2xx] CPU
                new MonitorItemConfig { Key = "CPU.Load",  SortIndex = 201, VisibleInPanel = true, VisibleInTaskbar = true, TaskbarColumnGroup = "cpu", IconKey = "cpu", TaskbarLabel = " " },
                new MonitorItemConfig { Key = "CPU.Temp",  SortIndex = 202, VisibleInPanel = true, VisibleInTaskbar = true, TaskbarColumnGroup = "cpu", IconKey = "cpu_temp", TaskbarLabel = " " },
                ...
                // [3xx] GPU
                new MonitorItemConfig { Key = "GPU.Load",  SortIndex = 301, VisibleInPanel = true, VisibleInTaskbar = true, TaskbarColumnGroup = "gpu", IconKey = "gpu", TaskbarLabel = " " },
                new MonitorItemConfig { Key = "GPU.Temp",  SortIndex = 302, VisibleInPanel = true, VisibleInTaskbar = true, TaskbarColumnGroup = "gpu", IconKey = "gpu_temp", TaskbarLabel = " " },
                ...
                new MonitorItemConfig { Key = "MEM.Load",  SortIndex = 401, VisibleInPanel = true, VisibleInTaskbar = true, TaskbarColumnGroup = "host", IconKey = "memory", TaskbarLabel = " " },
                ...
                // [7xx] NET
                new MonitorItemConfig { Key = "NET.Up",    SortIndex = 701, TaskbarSortIndex = 1, VisibleInPanel = true, VisibleInTaskbar = true, TaskbarColumnGroup = "network", IconKey = "network_up", TaskbarLabel = " " },
                new MonitorItemConfig { Key = "NET.Down",  SortIndex = 702, TaskbarSortIndex = 2, VisibleInPanel = true, VisibleInTaskbar = true, TaskbarColumnGroup = "network", IconKey = "network_down", TaskbarLabel = " " },
